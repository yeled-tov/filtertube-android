...
data class Video(
    ...
    val localUri: String = "",
    /**
     * האם ההורדה יצאה לדרך מתוך FilterMusic.
     *
     * בלי הסימון הזה אי אפשר להפריד בין "הורדתי שיר במיוזיק" ל"הורדתי
     * סרטון בפילטר טיוב": שתיהן נשמרות לאותה רשימה, ו"אודיו מול וידאו"
     * אינו מבדיל — גם בפילטר טיוב קטגוריות מסוימות יורדות כאודיו בכפייה.
     *
     * ברירת מחדל false, ולכן הורדות שכבר שמורות במכשיר נשארות בפילטר טיוב.
     */
    val fromMusic: Boolean = false,
) {
